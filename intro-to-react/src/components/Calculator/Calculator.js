...
class Calculator extends Component {
  ...
  calculate(){
    ...
    var result = 
    (this.state.operator === "*") ? (this.state.temp * parseInt(this.state.display,10)) : 
    (this.state.operator === "-") ? (this.state.temp - parseInt(this.state.display,10)) : 
    (this.state.operator === "+") ? (this.state.temp + parseInt(this.state.display,10)) : 
    (this.state.operator === "/") ? (this.state.temp / parseInt(this.state.display,10)) : 
  ...
  render() {
    ...
    return (
        <div id="calculator-container">
          ...
          <input onChange= { (event) => this.updateHeader(event.target.value) } id="header-input"/>
